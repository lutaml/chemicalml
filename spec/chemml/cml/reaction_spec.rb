...
RSpec.describe Chemml::Cml::Reaction do
  let(:reaction) do
    described_class.new(
      id: "r1",
      title: "Haber",
        ...
        reactants: [
          Chemml::Cml::Reactant.new(
            substance: Chemml::Cml::Substance.new(
              molecule: Chemml::Cml::Molecule.new(
                id: "r-m1",
                atom_array: Chemml::Cml::AtomArray.new(
                  atoms: [Chemml::Cml::Atom.new(id: "a1", element_type: "N", count: "1")]
                )
              )
            )
          )
      ...
      product_list: Chemml::Cml::ProductList.new(
        products: [
          Chemml::Cml::Product.new(
            substance: Chemml::Cml::Substance.new(
              molecule: Chemml::Cml::Molecule.new(
                id: "p-m1",
                atom_array: Chemml::Cml::AtomArray.new(
                  atoms: [
                    Chemml::Cml::Atom.new(id: "pa1", element_type: "N", count: "1"),
                    Chemml::Cml::Atom.new(id: "pa2", element_type: "H", count: "3")
                  ]
                )
              )
            )
