...
RSpec.describe Chemml::Cml::Molecule do
  let(:water) do
    described_class.new(
      id: "m1",
      atom_array: Chemml::Cml::AtomArray.new(
        atoms: [
          Chemml::Cml::Atom.new(id: "a1", element_type: "H", count: "2"),
  ...
  it "carries names and identifiers" do
    mol = described_class.new(
      id: "m1",
      names: [Chemml::Cml::Name.new(content: "water")],
      identifiers: [Chemml::Cml::Identifier.new(value: "InChI=1/H2O/h1H2", convention: "iupac:inchi")]
    )
