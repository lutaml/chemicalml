...
RSpec.describe Chemml::Cml::Document do
  ...
  it "round-trips a complex document preserving all fields" do
    original = Chemml::Cml::Document.new(
      molecules: [
        Chemml::Cml::Molecule.new(
          id: "m1",
          names: [Chemml::Cml::Name.new(content: "methanol")],
          atom_array: Chemml::Cml::AtomArray.new(
            atoms: [
              Chemml::Cml::Atom.new(id: "a1", element_type: "C"),
              Chemml::Cml::Atom.new(id: "a2", element_type: "O"),
              Chemml::Cml::Atom.new(id: "a3", element_type: "H", count: "4")
            ]
          ),
          bond_array: Chemml::Cml::BondArray.new(
            bonds: [
              Chemml::Cml::Bond.new(id: "b1", atom_refs2: "a1 a2", order: "S"),
              Chemml::Cml::Bond.new(id: "b2", atom_refs2: "a1 a3", order: "S")
            ]
          )
        )
      ]
